...
public class StudentLogin extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        forgot.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(StudentLogin.this,ResetPassword.class);
                startActivity(i);
            }
        });
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(StudentLogin.this, "Sign In Failed",
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(StudentLogin.this, "Sign Up Failed",
                                    Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    ...
    private void onAuthSuccess(FirebaseUser user) {
        ...
        // Go to MainActivity
        startActivity(new Intent(StudentLogin.this, StudentDetailActivity.class));
        finish();
    }
    ...
    private void writeNewUser(String userId, String name, String email) {
        ...
        mDatabase.child("users/students").child(userId).setValue(user);
    }
    // [END basic_write]
